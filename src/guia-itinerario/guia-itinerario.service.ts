...
export class GuiaItinerarioService {
  ...
  async create(GuiaItinerarioDto: CreateGuiaItinerarioDto): Promise<{ message: string }> {
  ...
  async update(updateGuiaItinerarioDto: UpdateGuiaItinerarioDto): Promise<{ message: string }> {
    const result = await this.GuiaItinerarioRepository.query(`
              DECLARE @MENSAJE AS NVARCHAR(100);
  ...
  async remove(deleteGuiaItinerarioDto: DeleteRestoreGuiaItinerarioDto): Promise<{ message: string }> {
    const result = await this.GuiaItinerarioRepository.query(`
              DECLARE @MENSAJE AS NVARCHAR(100);
  ...
  async restore(restoreGuiaItinerarioDto: DeleteRestoreGuiaItinerarioDto): Promise<{ message: string }> {
    const result = await this.GuiaItinerarioRepository.query(`
